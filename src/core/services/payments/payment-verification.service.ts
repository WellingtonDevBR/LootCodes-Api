...
import type { IPaymentVerificationService } from '../../ports/payment-verification-service.port.js';
import type { VerifyPaymentDto, PaymentVerificationResult } from './payment.types.js';
import { ValidationError } from '../../errors/domain-errors.js';
import { createLogger } from '../../../shared/logger.js';

const logger = createLogger('payment-verification-service');

@injectable()
export class PaymentVerificationService implements IPaymentVerificationService {
  constructor(
